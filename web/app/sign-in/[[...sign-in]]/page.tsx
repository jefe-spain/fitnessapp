...
export default async function SignInPage() {
  ...
  // Custom sign-in page with DaisyUI and Tailwind
  return (
      ...
      <div className="card w-full max-w-md bg-base-100 shadow-xl">
        <div className="card-body">
          <div className="text-center mb-6">
            ...
            <p className="text-base-content opacity-70 mt-2">Sign in to manage your fitness app</p>
          </div>
          
          <div className="divider">Admin Access Only</div>
